	 				...
	 				<thead>
	 					...
	 					<tr>
	 						<td colspan="10" rowspan="4" style="border-width: 4px">
	 							<h3 class="text-center"><i class="fab fa-shopify"></i>May Collections Online Shop</h3>
	 							<h6 class="text-center"><i class="fas fa-home mr-1"></i>No(272) B-2 Parami Road, Yangon</h6>
	 							<h6 class="text-center"><i class="fas fa-phone mr-1"></i>Tel:09756855424 ,09976543221</h6>
	 							<h6 class="text-center">ဝယ်ယူအားပေးတဲ့အတွက်ကျေးဇူးတင်ပါတယ်</h6>
	 						</td>
